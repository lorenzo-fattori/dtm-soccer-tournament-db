...
This project implements a **relational database** for a soccer tournament, storing information about players, teams, matches, leagues, referees, and contracts. It demonstrates the use of **SQL** for creating tables, inserting data, and running queries to analyze player performance, match history, and referee assignments.
